...
// ── 墙（厚 6px，确保 12px 步长寻路无法穿越） ───────────────────
const WALL: Rect[] = [
  // 外墙
  { x: 28, y: 28, w: 584, h: 8 },
  { x: 28, y: 412, w: 584, h: 8 },
  { x: 28, y: 28, w: 8, h: 392 },
  { x: 604, y: 28, w: 8, h: 392 },

  // 上排房间垂直分隔（知识库 / 工坊 / 升级中心）
  { x: 212, y: 36, w: 8, h: 154 },
  { x: 392, y: 36, w: 8, h: 154 },

  // 上排底墙（功能区 vs 主走廊）
  { x: 36, y: 190, w: 568, h: 6 },

  // 主走廊底墙（vs 下半区）
  { x: 36, y: 236, w: 568, h: 8 },

  // 中央开放工位 左墙 / 右墙
  { x: 176, y: 244, w: 8, h: 168 },
  { x: 432, y: 244, w: 8, h: 168 },

  // 左侧三房水平分隔
  { x: 36, y: 300, w: 140, h: 4 },
  { x: 36, y: 356, w: 140, h: 4 },

  // 右侧三房水平分隔
  { x: 440, y: 300, w: 164, h: 4 },
  { x: 440, y: 356, w: 164, h: 4 },
];

// ── 门洞（覆盖在墙上，重新开通走道） ────────────────────────────
const DOOR: Rect[] = [
  // 上排三房 → 主走廊（每房一道门）
  { x: 114, y: 190, w: 24, h: 8 },
  { x: 294, y: 190, w: 24, h: 8 },
  { x: 488, y: 190, w: 24, h: 8 },

  // 开放工位 ↔ 主走廊（中央大门）
  { x: 296, y: 236, w: 40, h: 12 },

  // 左侧三房 ↔ 开放工位（朝右开门）
  { x: 172, y: 260, w: 16, h: 24 },
  { x: 172, y: 318, w: 16, h: 22 },
  { x: 172, y: 374, w: 16, h: 24 },

  // 右侧三房 ↔ 开放工位（朝左开门）
  { x: 428, y: 260, w: 16, h: 24 },
  { x: 428, y: 318, w: 16, h: 22 },
  { x: 428, y: 374, w: 16, h: 24 },
];
